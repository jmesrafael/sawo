      ...
      >
          ...
          {NAV.map(({ to, label, icon }) => {
            ...
            return (
              <Link
                ...
                onMouseEnter={e => {
                  if (!active) e.currentTarget.style.background = "rgba(0,0,0,0.15)";
                }}
                onMouseLeave={e => {
        ...
        <div style={{ padding: "1rem 0.8rem", borderTop: "1px solid rgba(255,255,255,0.1)" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.6rem" }}>
            {/* Logout Icon like Toggle, with Nav-style hover */}
            <button
            ...
            >
              <i className="fas fa-sign-out" style={{ transform: "rotateY(180deg)" }}></i>
            </button>
